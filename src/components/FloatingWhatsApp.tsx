...
const MESSAGE = encodeURIComponent(
  "Hello! I'm interested in renting a space at NGson. Can you tell me more about availability?"
);
    ...
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-2">
      <AnimatePresence>
        {tooltipVisible && (
          <motion.div
            ...
            className="bg-white dark:bg-slate-800 text-slate-800 dark:text-slate-100 text-sm font-medium px-4 py-2 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-700 whitespace-nowrap"
          >
      ...
      <div className="relative flex items-center">
        ...
        <motion.a
          ...
          aria-label="Chat with NGson on WhatsApp"
